...
# build directory.
TK_BUILD_LIB_SPEC='-L/src/tcltk/tk8.5.8/win -ltk85'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/src/tcltk/tk8.5.8/win -ltkstub85'
...
TK_BUILD_STUB_LIB_PATH='/src/tcltk/tk8.5.8/win/tkstub85.lib'
