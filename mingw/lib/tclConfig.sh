...
TCL_DEFS='-DPACKAGE_NAME=\"\" -DPACKAGE_TARNAME=\"\" -DPACKAGE_VERSION=\"\" -DPACKAGE_STRING=\"\" -DPACKAGE_BUGREPORT=\"\" -DSTDC_HEADERS=1 -DHAVE_NO_SEH=1 -DEXCEPTION_DISPOSITION=int -DHAVE_WINNT_IGNORE_VOID=1 -DHAVE_ALLOCA_GCC_INLINE=1 -DHAVE_CAST_TO_UNION=1 -DTCL_CFGVAL_ENCODING=\"cp1252\" -DTCL_CFG_OPTIMIZED=1 -DTCL_CFG_DEBUG=1 '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/src/tcltk/tcl8.5.5/win -ltcl85'
...
# compiled.
TCL_SRC_DIR='/src/tcltk/tcl8.5.5'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/src/tcltk/tcl8.5.5/win -ltclstub85'
...
TCL_BUILD_STUB_LIB_PATH='/src/tcltk/tcl8.5.5/win/libtclstub85.a'
