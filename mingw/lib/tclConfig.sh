...
# build directory.
TCL_BUILD_LIB_SPEC='-L/src/tcltk/tcl8.5.7/win -ltcl85'
...
# compiled.
TCL_SRC_DIR='/src/tcltk/tcl8.5.7'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/src/tcltk/tcl8.5.7/win -ltclstub85'
...
TCL_BUILD_STUB_LIB_PATH='/src/tcltk/tcl8.5.7/win/libtclstub85.a'
