...
#define _STRACE_ALL	 0x00001
#define _STRACE_FLUSH	 0x00002
#define _STRACE_INHERIT  0x00004
#define _STRACE_UHOH	 0x00008
#define _STRACE_SYSCALL	 0x00010
#define _STRACE_STARTUP	 0x00020
#define _STRACE_DEBUG    0x00040
#define _STRACE_PARANOID 0x00080
#define _STRACE_TERMIOS	 0x00100
#define _STRACE_SELECT	 0x00200
#define _STRACE_WM	 0x00400
#define _STRACE_SIGP	 0x00800
#define _STRACE_MINIMAL	 0x01000
#define _STRACE_EXITDUMP 0x04000
#define _STRACE_SYSTEM	 0x08000
#define _STRACE_NOMUTEX	 0x10000
#define _STRACE_MALLOC	 0x20000
#define _STRACE_THREAD	 0x40000
#define _STRACE_NOTALL	 0x80000
